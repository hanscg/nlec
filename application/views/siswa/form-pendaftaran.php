<div id="content" class="app-content" role="main">
  ...
  <div class="panel panel-default">
    <div class="panel-heading font-bold">
      <h1 class="m-n font-semibold h4 text-grey padder">Form Pendaftaran Siswa</h1>
    </div>
    <div class="panel-body">
      <form class="form-horizontal" method="post" action="<?php echo base_url('siswa/addSiswa') ?>" role="form">
