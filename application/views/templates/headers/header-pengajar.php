         ...
         <!-- nav -->
          <nav ui-nav class="navi clearfix">
            <ul class="nav">
              ...
              <li class="active">
                <a href="<?= base_url('pengajar') ?>" class="auto">
                  <i class="fa fa-folder-open"></i>
                  <span class="font-bold">Daftar Pengajar</span>
                </a>
              </li>
              <li>
                <a href="<?= base_url('pengajar/tambah') ?>" class="auto">
                  <i class="fa fa-users"></i>
                  <span class="font-bold">Tambah Pengajar</span>
                </a>
              </li>
          </ul>
        </nav>
