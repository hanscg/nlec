         ...
         <!-- nav -->
          <nav ui-nav class="navi clearfix">
            <ul class="nav">
              ...
              <!-- <li class="active"> -->
              <li>
                <a href="<?= base_url('kelas/') ?>" class="auto">
                  <i class="fa fa-folder-open"></i>
                  <span class="font-bold">Daftar Kelas</span>
                </a>
              </li>
              <li>
                <a href="<?= base_url('kelas/tambah') ?>" class="auto">
                  <i class="fa fa-plus-square"></i>
                  <span class="font-bold">Tambah Kelas</span>
                </a>
              </li>
              <li>
                <a href="<?= base_url('kelas/assign') ?>" class="auto">
                  <i class="fa fa-users"></i>
                  <span class="font-bold">Assign siswa ke dalam kelas</span>
                </a>
              </li>
          </ul>
        </nav>
